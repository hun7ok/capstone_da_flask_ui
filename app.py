...
playstore['content_rating'] = playstore['content_rating'].astype('category')
...
def index():
    ...
    plt.savefig('cat_order_fix.png',bbox_inches="tight") 
    ...
    plt.xlabel('Reviews')
    plt.ylabel('Rating')
    plt.savefig('rev_rat_fix.png',bbox_inches="tight")
    ...
    plt.savefig('hist_size_fix.png',bbox_inches="tight")
    ...
    plt.xlabel('Content')
    plt.ylabel('Jumlah')
    plt.savefig('bar_fix.png',bbox_inches="tight")
...
if __name__ == "__main__": 
    app.run(host="0.0.0.0",debug=True,port=8866)
